...
@interface RealmSwiftObject (SWIFT_EXTENSION(RealmResultsController))
/// Use this func to notify the RRC of changes done in a specific object.
/// Useful when you modify an object inside a write transaction but without doing an <code>add</code> or <code>create</code> action like:
/// \code
/// let user = User()
/// user.name = "old name"
///
...
///   </li>
/// </ul>
/// \param object Original object (T) to mirror 
///
- (nonnull instancetype)getMirror SWIFT_WARN_UNUSED_RESULT;
...
///   </li>
/// </ul>
- (id _Nullable)primaryKeyValue SWIFT_WARN_UNUSED_RESULT;
@end
